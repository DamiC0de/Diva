...
import { View, StyleSheet, TextInput, Alert, TouchableOpacity, Image, KeyboardAvoidingView, Platform, ScrollView, Keyboard, TouchableWithoutFeedback } from 'react-native';
...
export default function LoginScreen() {
  ...
  return (
    <KeyboardAvoidingView
      style={[styles.container, { backgroundColor: theme.bg, paddingTop: insets.top, paddingBottom: insets.bottom }]}
