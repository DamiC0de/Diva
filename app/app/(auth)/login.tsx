...
import { View, StyleSheet, TextInput, Alert, TouchableOpacity, Image, KeyboardAvoidingView, Platform, ScrollView } from 'react-native';
...
export default function LoginScreen() {
  ...
  return (
    ...
    >
      <ScrollView
        contentContainerStyle={{ flexGrow: 1, paddingTop: insets.top, paddingBottom: insets.bottom, paddingHorizontal: 28 }}
